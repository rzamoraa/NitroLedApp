  ...
  return (
    ...
    >
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <p className="text-sm"><span className="font-bold">El marco de titanio</span> va unido a una nueva pieza interna de aluminio mediante difusión en estado sólido, un proceso termomecánico pionero en la industria que une estos dos metales con una fuerza extraordinaria.</p>
          <p className="text-sm"><span className="font-bold">La estructura interna</span> está fabricada con aluminio 100% reciclado. Esto incrementa la proporción de materiales reciclados en nuestros productos y nos acerca a nuestros objetivos de sostenibilidad para 2030.</p>
        </div>
      </div>
